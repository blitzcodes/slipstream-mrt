;
(function () {
	Slipstream.Template = function (config, Col, Router, Session) {
		var getTemplate = function (type) {
			...
			loadValuesFromTemplate : function (t) {
				...
				//				if (config.debug.template && Meteor.isClient)
				//					Slipstream.debug("template::loadValuesFromTemplate - data " + JSON.stringify(data));
			...
			submitForm             : function (e, t) {
				...
				if (config.debug.template && Meteor.isClient)
					Slipstream.debug("template::submitForm - template.data " + JSON.stringify(data));
