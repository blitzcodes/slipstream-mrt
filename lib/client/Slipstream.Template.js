...
(function () {
	Slipstream.Template = function (config, Col, Router, Session) {
		var getTemplate = function (type) {
			...
			if (Meteor.isClient && config.debug.init && config.debug.template)
			...
			loadValuesFromTemplate : function (t) {
				...
				//				if (Meteor.isClient && config.debug.template)
		...
		var initialization = function () {
			...
			if (Meteor.isClient && config.debug.init && config.debug.template)
				Slipstream.debug("template::templateOptions = " + _.stringify(self.templateOptions));
