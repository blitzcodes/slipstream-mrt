...
(function () {
	...
	Slipstream.TemplateManager = function (config, Col, Router, Session) {
		Slipstream.groupCollapsed("Init Templates");
		...
		var self = {
			...
			renderColumnsBySession : function (forceReload) {
				...
				Slipstream.groupCollapsed("Templates.renderColumnsBySession");
				if (Meteor.isClient) {
			...
			renderInputsBySession  : function (forceReload) {
				...
				Slipstream.groupCollapsed("Templates.renderInputsBySession");
				if (Meteor.isClient) {
					Session.loadBySession(forceReload);
			...
			initialization         : _.once(function () {
				...
				Slipstream.groupCollapsed('Init Templates Routes');
